...
run_command "ODD FILES:" "find / -type f -name -o -name "*.txt" -o -name "*.kdbx" -o -name "*.zip" -o -name "*.bak" 2>/dev/null"
run_command "Config or Passw Files:" "find /var /opt /home -type f \( -iname "*conf*" -o -iname "*passw*" \)"
run_command "Config or Passw Strings:" "grep -r -lE "conf|pass" /var /opt /home"
